 ...
 *         du port série (port, vitesse, nb bits, parité, stop bits).
 *         Il y a aussi un bouton qui permet de rafraîchir la liste
 *         de ports disponibles. Le bouton annuler ferme le port série
 *         et sort de la fenêtre de configuration. Le bouton OK confirme
 *         la sélection.
 *
...
namespace LampeDel_Barin
{
    public partial class frmConfigPort : Form
    {
        ...
        public frmConfigPort(string nom, int vitesse, int nbBit, Parity parite, int stopBit)
        {
            ...
            comboBoxDataBits.SelectedItem = m_nbBit;
