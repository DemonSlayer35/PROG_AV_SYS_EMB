 ...
 * @version 1.4:  automne 2022 Ajout de la variable membre nomItem_, du paramètre iNomItem pour la fonction genererAffichage
 *                et ajout de l'affichage du nom de l'item sélectionné. Mohammad Barin Wahidi
...
namespace Lab2MachineDistBarin
{
    ...
    class Lcd4Lignes
    {
        ...
        /// <param name="iNomItem">nom de l'aliment</param>
        /// <returns></returns>
        public Boolean genererAffichage(int iIndexRangee, int iIndexColonne, int iCreditCents, int iRetourCents, int iPrixCents,
        Boolean iDistributionEnCours, Boolean iManqueCreditActif, Boolean iAnnulationEnCours, Boolean iQteZeroEnCours, string iNomItem)
        {
                ...
                (creditPrecedent_ != creditCourant_))
            {
                ...
                switch (etatCourantAffichage)
                {
                    ...
                    case (int)etatAffichage.AttenteConfirmation:
                        ...
                        lignesAffichage_[1] = "Case sélectionnée: " + Convert.ToChar(rangeeSelectionnee_ + 'A') + Convert.ToChar(colonneSelectionnee_ + '0') + ", Item: " + nomItem_;
